...
| [../agent_tasks/ffmpeg/README.md](../agent_tasks/ffmpeg/README.md) | 2026-09-18~ | **ffmpeg 편집 에이전트 task** — 프로젝트 당위성 실증용 사내 업무 벤치 1번 도메인. 선행 조사, 결정론적 검증기 15종, pilot 50과제, 검증기 관문(정답 50/50 · alts 13/13 · negatives 107/107) |
