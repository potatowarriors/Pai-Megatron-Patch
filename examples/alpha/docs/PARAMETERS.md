...
```bash
# 새로운 모델 설정 생성
cp configs/model/baseline_24L.yaml configs/model/my_model.yaml
# my_model.yaml 편집...
...
# 설정 로드
with open('configs/model/baseline_24L.yaml') as f:
...
- **설정 가이드**: [../configs/model/baseline_24L.yaml](../configs/model/baseline_24L.yaml)
