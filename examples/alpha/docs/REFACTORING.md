...
| 1.3 | baseline_48L.yaml 절대 경로 | Medium | 완료 |
...
### 1.3 baseline_48L.yaml 절대 경로 제거
...
**파일**: [examples/alpha/configs/model/baseline_48L.yaml](../configs/model/baseline_48L.yaml)
...
| `examples/alpha/configs/model/baseline_48L.yaml` | 수정 | 1.3 |
...
### HF config 생성 테스트
```bash
python alpha_config.py generate-hf-config baseline_48L
```
