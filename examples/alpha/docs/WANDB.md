...
이미 설정된 API 키:
```bash
ffbe195db0033ed7b92ba142cfd01ca70b29974d
```
...
bash train.sh baseline_24L h100x8 pretrain kormo_1pct env /tmp/test_wandb
...
# 3. 학습 실행
bash train.sh baseline_24L h100x8 pretrain kormo_1pct env ./outputs
