    ...
    def encode(self, json_line):
        ...
        for key in self.args.json_keys:
            ...
            for sentence in sentences:
                if self.args.patch_tokenizer_type in ["DeepSeekV2Tokenizer", "Qwen3Tokenizer", "Qwen2Tokenizer", "LLama3Tokenizer", "LLama2Tokenizer", "AlphaTokenizer"]:
...
def get_args():
    ...
    group.add_argument(
        ...
        type=str,
        required=True,
        choices=['Qwen3Tokenizer', 'Qwen2Tokenizer', 'LLamaTokenizer', 'DeepSeekV2Tokenizer', 'LLama3Tokenizer', 'LLama2Tokenizer', 'GPT2BPETokenizer', 'AlphaTokenizer'],
        help='What type of tokenizer to use.',
    )
